...
class StatBuilder:
    ...
    def __init__(self):
        ...
        file1 = open(direct + "\\Subprograms\\Program Data\\Class_Stat_Priorities.txt", 'r')
        file2 = open(direct + "\\Subprograms\\Program Data\\Race_Main_Boosts.txt", 'r')
        file3 = open(direct + "\\Subprograms\\Program Data\\Race_Subs_Boosts.txt", 'r')
